...
/*
 * Use logical birth time for birth time comparisons instead of the
 * maximum of logical and physical birth times. This is useful for
 * operations that care about user data changes rather than physical
